...
const SHARE_URL = "https://recognaizelite.vercel.app/tcmbrainQR";
...
export default function TcmBrainQRReportPage() {
          ...
          <>
            ...
            >
              ...
              <div className="bg-white px-5 sm:px-7 py-7">
                ...
                {/* PayNow QR — primary booth-floor close. Shantal uploads the
                    QR (with $12 + AI Wellness UEN baked in) to
                    public/aiwellness-paynow.png. */}
