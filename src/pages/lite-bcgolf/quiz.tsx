...
import { LITE_BCGOLF, stashQuizResult } from "src/utils/liteOne";
...
export default function BcGolfQuizPage() {
  ...
  useEffect(() => {
    if (currentStep >= steps.length && steps.length > 0) {
      ...
      stashQuizResult(score, LITE_BCGOLF);
      Router.replace(`${LITE_BCGOLF.basePath}/results`);
    }
