 ...
 *
 * Unreachable from this funnel's report page — kept only so the route can be
 * opened directly to check it.
 *
 ...
 */
export default function BcGolfReportFull() {
      ...
      <LiteShell scroll className="px-5 pb-16 sm:px-8">
        <div className="relative mx-auto w-full max-w-[520px] space-y-5 pt-6">
          <Reveal>
            <button
              type="button"
              onClick={() => Router.push(`${LITE_BCGOLF.basePath}/report`)}
