...
import { NTU_HOMECOMING, stashQuizResult } from "src/utils/liteOne";
...
export default function NtuHomecomingQuizPage() {
  ...
  useEffect(() => {
    if (currentStep >= steps.length && steps.length > 0) {
      ...
      stashQuizResult(score, NTU_HOMECOMING);
      Router.replace(`${NTU_HOMECOMING.basePath}/results`);
    }
