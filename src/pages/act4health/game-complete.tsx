...
import { ACT4HEALTH, readTask2Score } from "src/utils/liteOne";
 ...
 */
export default function Act4HealthGameComplete() {
  ...
  return (
    <>
      <Head>
        <title>Game complete | Act4Health</title>
      </Head>
      ...
      <LiteShell partnerLogo={ACT4HEALTH_LOGO}>
        <div className="relative flex flex-1 flex-col items-center justify-center overflow-hidden px-6 py-8">
          <div className="relative mx-auto w-full max-w-[440px] text-center">
            ...
            >
              <LiteButton onClick={() => Router.push(`${ACT4HEALTH.basePath}/quiz`)}>
                Continue
              </LiteButton>
            </div>
          </div>
