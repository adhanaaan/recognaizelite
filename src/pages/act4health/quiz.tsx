...
import { ACT4HEALTH, stashQuizResult } from "src/utils/liteOne";
...
export default function Act4HealthQuizPage() {
  ...
  useEffect(() => {
    if (currentStep >= steps.length && steps.length > 0) {
      ...
      stashQuizResult(score, ACT4HEALTH);
      Router.replace(`${ACT4HEALTH.basePath}/results`);
    }
  ...
  return (
    <>
      <Head>
        <title>Brain Health Quiz | Act4Health</title>
