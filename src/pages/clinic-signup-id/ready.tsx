...
import { CLINIC_SIGNUP_ID } from "src/utils/liteOne";
...
export default function ClinicSignupIdReady() {
      ...
      <LiteShell>
        <div className="relative flex flex-1 flex-col justify-center overflow-y-auto px-6 py-6">
          <div className="mx-auto w-full max-w-[400px]">
            ...
            >
              <LiteButton onClick={() => Router.push(`${CLINIC_SIGNUP_ID.basePath}/challenge`)}>
                {t.ready.cta}
              </LiteButton>
            </div>
          </div>
