...
import { clinicSignupIdReportCopy } from "src/data/clinicSignupIdReportCopy";
import type {
  LiteTwoBand,
  LiteTwoCopyCtx,
  LiteTwoPersona,
...
/**
 * /clinic-signup-id's report — the v2 scroll-snapped story, personalised.
 *
...
export default function ClinicSignupIdReport() {
  ...
  const data = useReportData(CLINIC_SIGNUP_ID);
  ...
  const copy = clinicSignupIdReportCopy(lang, persona, band);
