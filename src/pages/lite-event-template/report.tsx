...
/**
 * /lite-event-template's report — the v2 scroll-snapped story, personalised.
 *
...
export default function LiteEventTemplateReport() {
  ...
  const data = useReportData(LITE_EVENT_TEMPLATE);
