 ...
 * /lite-one/report. Follows b2cfunnel's PaywallScreen, with its teleconsult
 * clinic block replaced by the World Alzheimer's Month offer that used to sit
 ...
 */
export default function LiteOneReportFull() {
      ...
      <LiteShell scroll className="px-5 pb-16 sm:px-8">
        <div className="relative mx-auto w-full max-w-[520px] space-y-5 pt-6">
          <Reveal>
            <button
              type="button"
              onClick={() => Router.push("/lite-one/report")}
