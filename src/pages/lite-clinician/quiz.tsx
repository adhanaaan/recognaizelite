...
import { LITE_CLINICIAN, stashQuizResult } from "src/utils/liteOne";
...
export default function ClinicianQuizPage() {
  ...
  useEffect(() => {
    if (currentStep >= steps.length && steps.length > 0) {
      ...
      stashQuizResult(score, LITE_CLINICIAN);
      Router.replace(`${LITE_CLINICIAN.basePath}/results`);
    }
