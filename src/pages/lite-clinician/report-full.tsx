...
/**
 * Report page two — the upsell, reached from the "Unlock Now" button on
 * this funnel's report page. Follows b2cfunnel's PaywallScreen, with its
 * teleconsult clinic block replaced by the standing offer that used to sit at
 * the bottom of page one.
 *
 * Still the consumer-facing copy, inherited from the duplicate — the clinician
 * rewrite lands here and in UPSELL/OFFER, not in the layout.
 *
 ...
 */
export default function ClinicianReportFull() {
      ...
      <LiteShell scroll className="px-5 pb-16 sm:px-8">
        <div className="relative mx-auto w-full max-w-[520px] space-y-5 pt-6">
          <Reveal>
            <button
              type="button"
              onClick={() => Router.push(`${LITE_CLINICIAN.basePath}/report`)}
