 ...
 * /lite-two/report. A copy of /lite-one/report-full with this funnel's
 ...
 */
export default function LiteTwoReportFull() {
      ...
      <LiteShell scroll className="px-5 pb-16 sm:px-8">
        <div className="relative mx-auto w-full max-w-[520px] space-y-5 pt-6">
          <Reveal>
            <button
              type="button"
              onClick={() => Router.push(`${LITE_TWO.basePath}/report`)}
