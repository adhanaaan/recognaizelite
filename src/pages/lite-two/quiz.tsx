...
import { LITE_TWO, stashQuizResult } from "src/utils/liteOne";
...
export default function LiteTwoQuizPage() {
  ...
  useEffect(() => {
    if (currentStep >= steps.length && steps.length > 0) {
      ...
      stashQuizResult(score, LITE_TWO);
      Router.replace(`${LITE_TWO.basePath}/results`);
    }
