 ...
 * teleconsult clinic block replaced by the World Alzheimer's Month offer that
 * used to sit at the bottom of page one.
 *
 ...
 */
export default function WorldAlzReportFull() {
      ...
      <LiteShell scroll className="px-5 pb-16 sm:px-8">
        <div className="relative mx-auto w-full max-w-[520px] space-y-5 pt-6">
          <Reveal>
            <button
              type="button"
              onClick={() => Router.push(`${LITE_WORLDALZ.basePath}/report`)}
