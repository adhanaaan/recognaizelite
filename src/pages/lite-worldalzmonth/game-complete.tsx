...
import { LITE_WORLDALZ, readTask2Score } from "src/utils/liteOne";
 ...
 */
export default function WorldAlzGameComplete() {
      ...
      <LiteShell>
        <div className="relative flex flex-1 flex-col items-center justify-center overflow-hidden px-6 py-8">
          <div className="relative mx-auto w-full max-w-[440px] text-center">
            ...
            >
              <LiteButton onClick={() => Router.push(`${LITE_WORLDALZ.basePath}/quiz`)}>
                Continue
              </LiteButton>
            </div>
          </div>
