...
const BRAND: Record<string, BrandTheme> = {
  ...
  litebcgolf: {
    name: "Recog-Lite · Business China Golf 2026",
    partnerLogoSrc: null,
  ...
  liteevent: {
    name: "ReCOGnAIze Lite · Corporate events",
    partnerLogoSrc: null,
  ...
  // Same palette as liteone — /act4health is /lite-two's flow co-branded for
  // the ACT4Health clinic, so it reads the same on a partner's screen.
  act4health: {
    name: "Act4Health",
