...
import { parkwayShentonReportCopy } from "src/data/parkwayShentonReportCopy";
import type {
  LiteTwoBand,
  LiteTwoCopyCtx,
  LiteTwoPersona,
 ...
 * on the landing page, so the run reaches this page with the lead already
 * written. See PARKWAY_SHENTON in src/utils/liteOne.ts.
 *
...
export default function ParkwayShentonReport() {
  ...
  const data = useReportData(PARKWAY_SHENTON);
