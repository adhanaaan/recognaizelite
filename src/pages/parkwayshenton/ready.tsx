...
import { PARKWAY_SHENTON } from "src/utils/liteOne";
...
export default function ParkwayShentonReady() {
      ...
      <LiteShell>
        <div className="relative flex flex-1 flex-col justify-center overflow-y-auto px-6 py-6">
          <div className="mx-auto w-full max-w-[400px]">
            ...
            >
              <LiteButton onClick={() => Router.push(`${PARKWAY_SHENTON.basePath}/challenge`)}>
                {t.ready.cta}
              </LiteButton>
            </div>
          </div>
